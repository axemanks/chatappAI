...
router.post("/text", async (req, res) => {
  try {
    ...
    const response = await openai.createChatCompletion({
      model: "gpt-3.5-turbo",
      messages: [
        { role: "system", content: "You are a smart, funny, witty assistant." }, // this represents the bot and what role they will assume
      ...
      messages: [
        {
          role: "system",
          content:
            "You are an coding professor, helping students to learn by explaining concepts and examples.",
